---
title: "Lost File"
date: 2025-11-12 18:30:00 +0000
categories: [Writeups, Forensics, Securinets Quals CTF 2025]
tags: [forensics, writeup]
description: Securinets Quals CTF 2025 - Lost File Writeup
---
...
4�=wJz@/�#�u�G���2Uɉ�x�<���цC���B����q��".��a����{x9�YbG����d�N�2�9��o���J�$}����Р)^�D�1��z���HW��h�\�;�^������T�&T�]�nF�<�l9��n�6\B
```
...
We can find the computer name by extracting the `SYSTEM` hive from the `disk.ad1` file at `C:\Windows\System32\config\SYSTEM` and then navigating to the registry key `HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\ComputerName\ComputerName` using a registry explorer tool. There we will find the value of the `ComputerName` - `RAGDOLLF-F9AC5A`.
